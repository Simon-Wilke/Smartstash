        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Group {
                        Text("Last updated: August 08, 2025\n")
                            .font(.subheadline)
                            .foregroundColor(.gray)
                            .padding(.horizontal)
...
Application refers to Smartstash Finance, the software program provided by the Company.

Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Smartstash Finance.
...
""")
                    ...
                    Group {
                        Text("Sharing Your Personal Data")
                            .font(.subheadline.bold())
                            .padding(.horizontal)
...
""")
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Link("Contact Us Here", destination: URL(string: "https://docs.google.com/forms/d/e/1FAIpQLSe37NDleJ6bh0Q_1SuwANpRS9PqWW2Yz78_mFBob0ubLLZtbw/viewform?usp=sharing&ouid=107430378900443897255")!)
                                .font(.body)
